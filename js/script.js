    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      function updateStats() {
        ...
        document.getElementById("sidebar-completed-tasks").textContent = counts.done;
        document.getElementById("sidebar-inprogress-tasks").textContent = counts["in-progress"];
